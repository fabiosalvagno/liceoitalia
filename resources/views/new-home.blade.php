...
<!-- Corso Pre-A1 -->
<section class="flex flex-col md:flex-row-reverse items-center justify-center gap-[5px] bg-gray-100 py-12 px-8">
    <div class="md:w-1/2">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">📘 ゼロから始めるイタリア語</h2>
        <p class="text-lg text-gray-700 leading-relaxed">
            まったく初めての方のための入門コースです。<br>
            ゆっくり丁寧に、基本のあいさつ・会話・文法を学びます。<br>
    ...
    <div class="md:w-1/2">
        <img src="{{ asset('img/landing/Travelers-pana.svg') }}" alt="Italian Class Pre-A1"
             class="w-full rounded-lg shadow-md">
    </div>
</section>
